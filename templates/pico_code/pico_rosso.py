...
def loop():
    ...
    # ----------------------------------------------------
    # FIRMA ELETTRICA ROSSA: PWM a 1250 Hz
    # L'impulso HIGH durerà esattamente ~400 microsecondi
    # ----------------------------------------------------
    pwm13 = PWM(Pin(13))
    pwm13.freq(1250)
    ...
    while True:
        try:
            ...
            # --- 1. LETTURA PUNTA (Aspetto la MIA firma: ~400us) ---
            ...
            if 150 < pw_14 < 650:
                is_hit = True
                debug_msg = "PUNTA_ROSSA_CHIUSA"

            # --- 2. LETTURA COCCIA (Aspetto la MIA firma ~400us o la VERDE ~2000us) ---
            pw_15 = -1
            ...
            elif 1000 < pw_15 < 3000:
                is_coccia = True
                debug_msg = "LAMA_VERDE_SU_MIA_COCCIA"
