...
def loop():
    ...
    pin13 = Pin(13, Pin.IN, Pin.PULL_DOWN) # A
    pin14 = Pin(14, Pin.IN, Pin.PULL_DOWN) # B
    pin15 = Pin(15, Pin.IN, Pin.PULL_DOWN) # C (Coccia)
    ...
    while True:
        try:
            ...
            # --- ASCOLTO PASSIVO (Per captare D, E, F dell'altra Pico) ---
            for _ in range(5):
                if pin15.value() == 1: is_coccia = True
                time.sleep_us(100)
